...
function Home() {
  ...
  const renderView = () => (
    ...
    return (
      <>
        <div className='mb-3'>
          <h1 className='font-medium text-xl bg-gradient-to-r from-[#071952] to-[#088395] bg-clip-text text-transparent'>Our Products Online</h1>
        </div>
        <div className='flex justify-between items-center w-full max-w-[340px] mb-3 p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all shadow-sm text-gray-700 placeholder-gray-400'>
          <input 
            type="text" 
          ...
          />
          <div 
            className='cursor-pointer hover:w-105 mr-2'
